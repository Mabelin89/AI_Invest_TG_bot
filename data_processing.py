...
def optimize_yearly_macro(yearly_macro_df):
    ...
    key_columns = {
        ...
        'Ключевая ставка (%)': 'Rate',
        'Торговый баланс (млрд USD)': 'TradeBalance',
        'Бюджетный дефицит (% ВВП)': 'BudgetDeficit',
        'MOEX (конец года)': 'MOEX',
...
Макро годовые ({period_years} лет, год|GDP|CPI|Unemployment|Rate|TradeBalance|BudgetDeficit|MOEX|USD/RUB|CCI, |, \n):
...
4. Сравни NP и Assets с GDP, CPI, Unemployment, Rate, TradeBalance, BudgetDeficit, MOEX, USD/RUB, CCI за те же годы.
5. Оцени влияние макро на показатели.
6. Формат ответа:
Годы:2008|2009|...|LTM
...
4. Учти макроэкономические данные:
   - Сравни динамику Чистой прибыли и Активов компании с GDP, CPI, Unemployment, Rate, TradeBalance, BudgetDeficit, MOEX, USD/RUB, CCI за те же годы.
   - Отметь влияние макроэкономических факторов на показатели компании.
