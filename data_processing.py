...
def analyze_msfo_report(ticker, base_ticker, chat_id, bot):
...
"""
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": system_message.format(msfo_content=msfo_content, rsbu_content=rsbu_content if rsbu_content else "Отсутствует")},
